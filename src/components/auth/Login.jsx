...
import { Sparkles, Mail, Lock, Eye, EyeOff, ArrowLeft, AlertCircle, RotateCw } from 'lucide-react';
    ...
    >
      ...
      <div className="text-center space-y-2 mb-8">
        ...
        <p className="text-xs text-gray-400">
          Sign in to access your personalized student workspace.
        </p>
      </div>
        ...
        <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/20 flex items-start gap-3 text-amber-300 text-xs mb-6">
          ...
          <div>
            ...
            <p className="text-amber-300/80 mt-0.5">
              Set <code className="text-white font-mono">VITE_SUPABASE_URL</code> and <code className="text-white font-mono">VITE_SUPABASE_ANON_KEY</code> to enable live cloud authentication.
            </p>
          </div>
        </div>
      )}
